...
// the first sync. Also publishes the effective zone as the app's active timezone (P2 Timezones), so
// the date helpers reason in the account zone. Renders nothing; mounted once inside the provider.
export function TimezoneSync() {
  ...
  useEffect(() => {
    ...
    // Publish the effective zone (pinned, or the detected one while auto) for the date helpers.
