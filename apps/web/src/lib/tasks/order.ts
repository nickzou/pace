...
// Manual ordering (P2-06) — the one place the fractional-key library is called, so web and
// mobile stay identical (this file is mirrored in apps/mobile/lib/tasks/order.ts).
//
