...
// The items table — a generic synced resource demonstrating offline-first patterns.
// This is the persistence mirror of a shared itemSchema, plus the DB-only `userId`
